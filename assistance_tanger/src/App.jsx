  ...
  const galleryImages = [
    {
      ...
      brand: "Mercedes-Benz",
      name: "dépannage voiture en panne Tanger",
    },
    {
      src: whatsappGallery2,
      brand: "Jet Skis",
      name: "assistance en Tanger Med",
    },
    {
      src: whatsappGallery3,
      brand: "Lamborghini Urus",
      name: "remorquage poids lourd Tanger",
    },
    {
      src: whatsappGallery4,
      brand: "Lamborghini Urus",
      name: "dépannage autoroute Tanger Med",
    }
  ];
          ...
          <div className="px-4 py-4 space-y-1.5">
            ...
            <div className="pt-4 mt-2 border-t border-slate-100">
              <a href={phoneLink} className="flex items-center justify-center gap-2 w-full bg-amber-500 hover:bg-amber-400 text-white px-5 py-3.5 rounded-xl font-semibold transition-colors">
                <PhoneCall aria-hidden="true" className="w-5 h-5" />
                <span dir="ltr">{phoneNumber}</span>
              </a>
            </div>
          </div>
      ...
      <section id="services" className="py-16 md:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              { icon: <Car aria-hidden="true" className="w-8 h-8" />, color: "blue", title: t('srv1_title'), desc: t('srv1_desc') },
              { icon: <Truck aria-hidden="true" className="w-8 h-8" />, color: "red", title: t('srv2_title'), desc: t('srv2_desc') },
              { icon: <Wrench aria-hidden="true" className="w-8 h-8" />, color: "amber", title: t('srv3_title'), desc: t('srv3_desc') },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <div className="reveal delay-200 order-1 lg:order-2">
              ...
              <a href={phoneLink} className="inline-flex justify-center w-full sm:w-auto bg-blue-900 hover:bg-blue-800 text-white px-6 md:px-8 py-3.5 md:py-4 rounded-xl font-bold transition-colors shadow-lg items-center gap-2">
                {t('about_btn')}
                <ArrowRight aria-hidden="true" className={`w-5 h-5 ${isRtl ? 'rotate-180' : ''}`} />
              </a>
            </div>
          </div>
        </div>
